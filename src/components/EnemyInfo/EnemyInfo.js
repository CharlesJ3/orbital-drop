      ...
      { labels &&
        <Html className='enemyInfo no-pointer' distanceFactor={30}>
          ...
          <div className='enemyInfo__info'>
            <div className='enemyInfo__info__defense'>DEF <br />{defense}</div>
            <div className='enemyInfo__info__xp'>EXP <br />{xp}</div>
          </div>
        </Html>
      }
      { labels &&
        ...
        <Html className='enemyInfo__status no-pointer' distanceFactor={30}>
          ...
          <div className='wrapper'>
            <div className='enemyInfo__status__buffs'>
              { buffs.map((buff, i) => (
                <div key={i} className='individualBuff'
                  onMouseEnter={() => setHover((prevState => ({
                    ...prevState,
                    name: buff[0],
                    rank: buff[1],
                    description: buff[2],
            ...
            <div className='enemyInfo__status__debuffs'>
              { debuffs.map((debuff, i) => (
                <div key={i} className='individualDebuff'
                  onMouseEnter={() => setHover((prevState => ({
                    ...prevState,
                    name: debuff[0],
                    rank: debuff[1],
