      ...
      <Html className='satellite' distanceFactor={35}>
        <span>---</span>
          <div className={
            ...
            tier === 'two' ? 'satellite__tierTwo' :
            tier === 'three' ? 'satellite__tierThree' :
            tier === 'four' ? 'satellite__tierFour' : ''
          }>
            <div className={
              props.settings.labelSize === 0 ? 'satellite__small' :
              props.settings.labelSize === 1 ? 'satellite__medium' :
              props.settings.labelSize === 2 ? 'satellite__large' : ''
            }>
