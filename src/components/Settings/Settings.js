		...
		<>
			<div className="settings">
				...
				<div className="settings__options">
					<p className="settings__options__toggleLabels" onClick={() => toggleLabels()}>
						{settings.showLabels ? 'Hide Labels' : 'Show Labels'}
					</p>
					<p onClick={() => toggleLabelsSize()} className="settings__options__toggleLabelsSize">
						Change Size
						<br />
						{settings.labelSize === 0
							? ' Small'
							: settings.labelSize === 1
							? ' Medium'
							: settings.labelSize === 2
							? ' Large'
							: ''}
					</p>
